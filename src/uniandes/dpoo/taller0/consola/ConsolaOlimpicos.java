...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la nacionalidad del atleta");
	...
	//FUNCION AGREGADA TALLER_0 MOD 1
	private void ejecutarNacionAtleta()
	{
		System.out.println("\n"+"MODIFICACION 1: NACION DEL ATLETA"+"\n");
		String nombre = input("Por favor ingrese el nombre de un atleta:");
		String elPaisaje = calculadora.buscarPaisAtleta(nombre);
		System.out.println("El pais que representa el atleta escogido es: "+ elPaisaje);
	}
